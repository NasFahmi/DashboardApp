            ...
            Expanded(
              child: Container(
                ...
                child: RefreshIndicator(
                  ...
                  child: controller.productDisplayList.isNotEmpty
                      ? Obx(() => GridView.count(
                            ...
                            children: List.generate(
                              controller.productDisplayList.length,
                              (index) {
                                          ...
                                          Container(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  maxLines: 2,
                                                  '${controller.productDisplayList[index].deskripsi}',
                                                  style: TextStyle(
                                                    color: AppColors
                                                        .labelTextColor,
                                                    fontSize: 10.sp,
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      'Rp ${controller.productDisplayList[index].harga}',
                                                      style: TextStyle(
                                                          fontSize: 14.sp,
                                                          color: AppColors
                                                              .primaryTextColor,
                                                    ...
                                                    Text(
                                                      'Stok : ${controller.productDisplayList[index].stok}',
                                                      style: TextStyle(
                                                        fontSize: 10.sp,
                                                        color: AppColors
                                                            .labelTextColor,
